...
#'
#' Summarize the parameters of an object of class ‘beepop_community’, return the label of  #' the community, a table of species and their size and the interaction matrix of the #’community.
#'
#' @param      x an object of class ‘beepop_community’
#' @param ... other parameter, not used in that version;
#'
#' @export display the label, the name and size of species and the matrix of interaction        #'  between the species
#'
#' @examples
